            ...
            public int SalesPersonID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'SalesPersonID\' в таблице \'SalesOrderHeader\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int TerritoryID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'TerritoryID\' в таблице \'SalesOrderHeader\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int CreditCardID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'CreditCardID\' в таблице \'SalesOrderHeader\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int CurrencyRateID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'CurrencyRateID\' в таблице \'SalesOrderHeader\' равно DBNull.", e);
                    }
                }
                set {
...
namespace ADO.Zachot4.AdventureWorks2017DataSetTableAdapters {
...
SELECT SalesOrderID, RevisionNumber, OrderDate, DueDate, ShipDate, Status, OnlineOrderFlag, SalesOrderNumber, PurchaseOrderNumber, AccountNumber, CustomerID, SalesPersonID, TerritoryID, BillToAddressID, ShipToAddressID, ShipMethodID, CreditCardID, CreditCardApprovalCode, CurrencyRateID, SubTotal, TaxAmt, Freight, TotalDue, Comment, rowguid, ModifiedDate FROM Sales.SalesOrderHeader WHERE (SalesOrderID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO.Zachot4.Properties.Settings.Default.AdventureWorks2017ConnectionString;
        }
        ...
        public virtual int Fill(AdventureWorks2017DataSet.SalesOrderHeaderDataTable dataTable) {
        ...
        public virtual AdventureWorks2017DataSet.SalesOrderHeaderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorks2017DataSet.SalesOrderHeaderDataTable dataTable = new AdventureWorks2017DataSet.SalesOrderHeaderDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorks2017DataSet.SalesOrderHeaderDataTable dataTable) {
